...
<html lang="en">
  ...
  <body onload="startTime()">
    ...
    <audio class="audio" src="song2.mp3" autoplay type="audio" loop=""></audio>
    <audio class="notif" src="song1.mp3" type="audio"></audio>
    ...
    <div class="main">
      <div class="content">
        ...
        <div class="notif notif1 kelip" onclick="balas()">
          ...
          <div class="isi">
            <p>Haloo sayang, isi nama kamu dong</p>
          </div>
        </div>
        ...
        <div class="btn-mulai">
          <p class="hilang1" onclick="notif1()">Sentuh Akuu</p>
